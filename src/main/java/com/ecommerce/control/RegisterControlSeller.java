...
@WebServlet(name = "RegisterControlSeller", value = "/register_seller")
@MultipartConfig
public class RegisterControlSeller extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        // Insert username, password to database and create account.
            ...
            accountDao.createAccountSeller(username, password, inputStream);
